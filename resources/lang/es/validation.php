...
return [
    ...
    */
    ...
    'custom' => [
        'foto_ruta' => [
            'max' => 'La imagen no puede ser mayor a :max kilobytes. Por favor selecciona una imagen más pequeña.',
            'image' => 'El archivo debe ser una imagen válida (JPG, PNG, etc).',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        'foto_ruta' => 'imagen del apoyo',
        'nombre_apoyo' => 'nombre del apoyo',
        'tipo_apoyo' => 'tipo de apoyo',
        'monto_maximo' => 'monto máximo',
        'cupo_limite' => 'cupo límite',
