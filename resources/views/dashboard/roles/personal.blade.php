...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-100 hover:border-indigo-500 transition-all duration-300">
            ...
            <h3 class="font-bold text-slate-800 text-lg">Caso presencial</h3>
            <p class="text-sm text-slate-500 mt-2">Gestiona el alta presencial y carga de documentos de beneficiarios.</p>
            <div class="mt-4 grid grid-cols-2 gap-3">
                <a href="{{ route('admin.caso-a.momento-uno') }}" class="inline-block w-full text-center py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 shadow-sm transition-colors text-sm">
                    Momento 1
                </a>
                <a href="{{ route('admin.caso-a.momento-dos') }}" class="inline-block w-full text-center py-2 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 shadow-sm transition-colors text-sm">
                    Momento 2
                </a>
            </div>
        </div>
