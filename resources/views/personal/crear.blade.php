<x-app-layout>
    ...
    <div class="relative bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div class="relative max-w-3xl mx-auto">
            ...
            <h1 class="text-3xl font-extrabold text-white mb-2">Agregar Nuevo Personal</h1>
            <p class="text-slate-300 text-sm">Completa el formulario para registrar un nuevo miembro del equipo en el sistema.</p>
        </div>
    </div>
    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                <form action="{{ route('personal.store') }}" method="POST" x-data="{ showPass: false, showPass2: false }">
                    @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="numero_empleado" value="{{ old('numero_empleado') }}"
                                    ...
                                    class="w-full px-4 py-2.5 border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-transparent transition @error('numero_empleado') border-red-500 @enderror" />
