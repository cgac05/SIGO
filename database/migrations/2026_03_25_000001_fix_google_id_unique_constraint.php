...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (Schema::hasTable('Usuarios')) {
            // Drop ALL problematic unique constraints that allow NULL
            ...
            // 2. remember_token - permitir múltiples NULLs (solo para usuarios autenticados)
            DB::statement('
            ...
            // 3. Crear filtered unique indexes para permitir NULLs duplicados
            DB::statement('
